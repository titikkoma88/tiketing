		...
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Progress Ticket</li>
			</ol>
		</div><!--/.row-->
...
<a href="#" style="text-decoration:none">Progress Ticket</a></div>
					...
					<div class="panel-body">
						<table data-toggle="table" data-show-refresh="false" data-show-toggle="true" data-show-columns="true" data-search="true"  data-pagination="true" data-sort-name="name" data-sort-order="desc">
                            ...
                            <tbody>
                           <?php $no = 0; foreach($datamyticketspv as $row) : $no++;?>
						     <tr>
						        ...
						        <td>
						        	<?php if($row->status==5 AND $row->feedback_history == "") {?>
	 								...
	 								<?php } else if($row->status==1){
	 									...
	 									<a href="javascript:SelesaiTiket('<?php echo $row->id_ticket; ?>');" class="hapus btn btn-danger btn-xs" data-toggle="tooltip" title="Konfimasi Ulang Pengajuan Tiket"><span class="glyphicon glyphicon-envelope" ></span></a>
	 								
	 								<?php } else if($row->status==4 AND $row->feedback_user=='Y'){
	 									?>
     									
	 									<a href="javascript:FeedbackUser('<?php echo $row->id_ticket; ?>');" class="ubah btn btn-success btn-xs" data-toggle="tooltip" title="Berikan Komentar"><span class="glyphicon glyphicon-comment" ></span></a><br>
	 									MENUNGGU FEEDBACK DARI USER 
	 								<?php } 
										else if($row->status==6 AND  $row->feedback_history == 1) { echo "TICKETING COMPLETED";}
										else if($row->status==6 AND $row->feedback_history == 0) { echo "TICKETING REPROCESS (COMPLAIN)";}
		...
		<div class="alert bg-warning" role="alert">
					<svg class="glyph stroked flag"><use xlink:href="#stroked-flag"></use></svg> Berikanlah Feeedback Sesuai Kondisi <a href="#" class="pull-right"><span class="glyphicon glyphicon-remove"></span></a>
				</div>	
