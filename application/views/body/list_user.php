			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading"><svg class="glyph stroked male user "><use xlink:href="#stroked-male-user"/></svg>
						<a href="#" style="text-decoration:none">List Ticket 

						<!--
							<a href="<?php echo base_url();?>list_ticket_user/pdflistticket/<?php echo $status;?>" class="btn btn-danger" target="_blank">Pdf</a>
						-->
						</a>   				
					</div>
					<div class="panel-body">
						<table data-toggle="table" data-show-refresh="false" data-show-toggle="true" data-show-columns="true" data-search="true"  data-pagination="true" data-sort-name="name" data-sort-order="desc">
						    <thead>
						    <tr>
						        <th data-field="no" data-sortable="true" width="10px"><?php $awal;?> No</th>
                            ...
                            <tbody>
                           <?php $no = 0; foreach($datalist_user as $row) : $no++;?>
						     <tr>
						        ...
						        <td data-field="id">
						        	<?php 
										...
										else if($row->status==4 AND $row->feedback=='Y' ) { echo "MENUNGGU FEEDBACK DARI USER";}
