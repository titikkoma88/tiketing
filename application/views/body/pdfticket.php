...
<div class="row">
	...
	<table class="table" border="1px" cellpadding="10" cellspacing="0" width="100%">
		<thead>
			<tr>
				<th width="10px"> No</th>
				<th width="10px">Id Ticket</th>
				<th width="10px">Reported</th>
				<th width="10px">Tanggal</th>
				<th width="10px">Nama Kategori</th>
				<th width="10px">Nama Sub Kategori</th>
				<th width="50px" >Problem Summary</th>
				<th width="10px">Status</th>
			</tr>
        </thead>
        <tbody>
         <?php $no = 0; foreach($dataticket as $row) : $no++;?>
			<tr>
	...
	<table>
		<tr>
			<td><b><?php echo $ticket_solved;?></b></td>
			<td><b>Ticket Solved</b></td>
		</tr><br>
		<tr>
			<td><b><?php echo $ticket_process;?></b></td>
			<td><b>Ticket Process</b></td>
		</tr><br>
		<tr>
			<td><b><?php echo $ticket_reprocess;?></b></td>
			<td><b>Ticket Reprocess</b></td>
		</tr><br>
		<tr>
			<td><b><?php echo $ticket_wait_approve;?></b></td>
			<td><b>Ticket Waiting Vendor Approval</b></td>
		</tr><br>
		<tr>
			<td><b><?php echo $ticket_wait_solve;?></b></td>
			<td><b>Ticket Waiting User Accept</b></td>
		</tr><br>
		<tr>
			<td><b><?php echo $ticket_cancel;?></b></td>
			<td><b>Ticket Cancel</b></td>
		</tr><br>
		<tr>
			<td><b><?php echo $jml_ticket;?></b></td>
			<td><b> Total Ticket <?php echo $namaapp;?></b></td>
		</tr><br>
		<tr>
			<td></td>
			<td></td>
		...
		<tr>
			<td><b><?php echo $jml_ticket_all;?></b></td>
