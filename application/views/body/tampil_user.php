	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				...
				<a href="" style="text-decoration:none">Tampilkan Laporan Ticket User</a>
			</div>
					...
					if ($awal && $akhir) 
						{
	                    	...
	                    	$no = 1;
	                    	foreach ($this->model_app->getjumlahtiketuser($awal, $akhir, $app) as $row) 
	                    	{
	                    		echo '<tr>';
	                    		echo '<td>'.$no.'</td>';
	                    		echo '<td>'.$row->nama.'</td>';
	                    		echo '<td><a href="../list_ticket_user/list_user/'.$row->reported.'/'.$awal.'/'.$akhir.'">'.$row->jumlah.'</a></td>';
	                    		echo '</tr>';
	                    		$no++;
	                    	}
	                    		echo '</tbody></table>';
