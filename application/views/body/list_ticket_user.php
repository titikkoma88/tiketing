...
<a href="#" style="text-decoration:none">List Ticket  <a href="<?php echo base_url();?>list_ticket_user/pdflistticket/<?php echo $status;?>" class="btn btn-danger" target="_blank">Pdf</a></a></div>
